...
const Dashboard = () => {
  ...
  const [userProfile, setUserProfile] = useState({
    name: 'Suchitra',
    email: localStorage.getItem('userEmail') || 'suchitra@gmail.com',
    rating: 1500,
  });

  const profiles = [
    { name: 'Suchitra', email: 'suchitra@gmail.com', rating: 1500 },
    { name: 'Varshitha', email: 'varshitha@gmail.com', rating: 1650 },
    { name: 'Jahnavi', email: 'jahnavi@gmail.com', rating: 1750 }
  ];
